...
// Is this bot clearly the current leader? Used to stop a winning bot from grabbing
// 'snap' (random half-wipe) and nuking its own lead. Small margin, so a near-tie
// still gambles on it as a deny tool.
